...
fn test_golden_path_monitoring() {
    ...
    // Create custom alert
    let _alert_id =
        engine.create_alert(AlertSeverity::Warning, "Test Alert", "This is a test alert");
...
fn test_dashboard_updates() {
    ...
    // Generate update
    let update = dashboard.generate_update(UpdateType::PnlUpdate, UpdatePayload::Pnl(1000.0));

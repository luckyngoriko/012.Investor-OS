...
fn test_materialized_view_indexes() {
    ...
    assert!(
        migration.contains("idx_mv_portfolio_daily_pk"),
        "mv_portfolio_daily should have unique index"
    );
    assert!(
        migration.contains("idx_mv_cq_history_pk"),

...
use investor_os::broker::multi_asset::{AssetClass, MultiAssetPortfolio, OrderRouter, UnifiedOrder, OrderSide, OrderType};
...
fn test_portfolio_allocation() {
    ...
    portfolio.positions.push(investor_os::broker::multi_asset::MultiAssetPosition {
...
fn test_cash_only_portfolio() {
    ...
    portfolio.cash_balances.insert("USD".to_string(), Decimal::from(10000));
    portfolio.calculate_total_value();

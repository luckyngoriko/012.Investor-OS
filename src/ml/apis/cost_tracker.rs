...
impl CostTracker {
    ...
    /// Record API usage
    pub fn record_usage(&self, provider: &str, tokens_input: u64, tokens_output: u64) -> f64 {
    ...
    fn calculate_cost(&self, provider: &str, tokens_input: u64, tokens_output: u64) -> f64 {
        ...
        let (input_price, output_price) = match provider {
            ...
            "openai" => (
                pricing.openai_gpt4o_mini_input,
                pricing.openai_gpt4o_mini_output,
            ),
...
impl<T> TrackedClient<T> {
    ...
    pub fn track_request(&self, actual_input: Option<u64>, actual_output: Option<u64>) -> f64 {
        ...
        self.tracker
            .record_usage(&self.provider_name, input, output)
    }

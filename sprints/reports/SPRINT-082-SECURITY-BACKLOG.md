...
|---|---|---|---|---|---|---|---|---|
| RUSTSEC-2024-0437 | protobuf 2.28.0 | vulnerability | `prometheus 0.13.4 -> investor-os` | open-risk-accepted | Temporary risk acceptance. No online crate upgrade available in current offline dev environment; planned upgrade to a protobuf-safe metrics path in next dependency maintenance window. | Platform Lead | 2026-03-15 | CI log run `22546841010` + `.cargo/audit.toml` |

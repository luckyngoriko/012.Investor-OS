...
total_tests="$(jq '[.[].test_title] | length' <<<"$combined_entries_json")"
total_warnings="$(jq '[.[].warning_count] | add // 0' <<<"$combined_entries_json")"
chart_warnings="$(jq '[.[].category_counts.chart_container // 0] | add // 0' <<<"$combined_entries_json")"
other_warnings="$(jq '[.[].category_counts.other // 0] | add // 0' <<<"$combined_entries_json")"

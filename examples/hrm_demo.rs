...
use investor_os::hrm::{HRM, HRMConfig, HRMBuilder, DeviceConfig};
...
fn main() {
    ...
    println!("\n📊 Inference Results:");
    println!("{:<20} {:>10} {:>12} {:>12}", "Scenario", "Conviction", "Confidence", "Trade?");
    println!("{:-<60}", "");
    ...
    let avg_conviction: f32 = batch_results.iter()
        .map(|r| r.conviction)
